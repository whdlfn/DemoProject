...
//		
		...
		// Authorization 헤더 생성
		String secretKey = "test_sk_XZYkKL4MrjLlPnldmgZm30zJwlEW";
 ...
 * SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ssXXX"); Date parsedDate =
 * dateFormat.parse(dateString);
 * 
 * // java.sql.Timestamp로 변환 Timestamp timestamp = new
 * Timestamp(parsedDate.getTime());
 * 
 * SalePayDetails dto = SalePayDetails.builder() .bcode(orderId) .amount(amount)
 * .buyUser("") .build();
 */